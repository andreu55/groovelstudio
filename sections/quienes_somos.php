...
<section class="section featured-artists quienes-somos" id="anchor01">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-3">
        <img class="img-responsive" src="images/about/juan_groovel.png" alt="Juan" style="margin:0 auto">
      </div>
      <div class="col-md-6">
      ...
      <div class="col-md-3">
        <img class="img-responsive" src="images/about/alberto_groovel.png" alt="Alberto" style="margin:0 auto">
      </div>
    </div>
    <div class="voffset80"></div>
  </div>
